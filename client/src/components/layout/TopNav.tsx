import { UserCircle, Bell, Home, Search, Calendar } from 'lucide-react';
  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-white/80 backdrop-blur-md border-b border-gray-100">
      <div className="flex items-center justify-between px-6 h-16 max-w-7xl mx-auto">
        ...
        {/* 2. Center Navigation (Pill Style) */}
            ...
            return (
              <Link
                ...
                className={clsx(
                  ...
                  isActive 
                    ? 'bg-white text-primary shadow-sm ring-1 ring-black/5' // Active State
                    : 'text-gray-500 hover:text-gray-900 hover:bg-gray-200/50' // Inactive State
                )}
              >
        ...
        {/* 3. Right Icons (Notifications & Profile) */}
        <div className="flex items-center gap-3">
          ...
          <Link to="/profile" className="flex items-center gap-2 pl-1 pr-2 py-1 rounded-full hover:bg-gray-50 transition-colors border border-transparent hover:border-gray-100">
             {/* Small Avatar Circle */}
            <div className="w-8 h-8 bg-gradient-to-tr from-blue-100 to-blue-50 rounded-full flex items-center justify-center text-primary">
              <UserCircle size={20} />
            </div>
          </Link>
        </div>
